...
export default function User(): JSX.Element {
    ...
    const [selectedSecretId, setSelectedSecretId] = useState<number | undefined>(undefined);
        ...
        <main className={styles.page}>
                ...
                <ul className={styles.cards}>
                    {
                        user.secrets.map((model: Secret) =>
                            <Card
                                text={model.name}
                                onClick={() => setSelectedSecretId(model.id)} />
                        )
                    }
                </ul>
            </div>
            {
                ...
                <SecretDialog
                    ...
                    onClose={() => setSelectedSecretId(undefined)}
                    onUpdate={setUser} />
            }
